...
if (isset($_POST['search'])) {
    ...
    $query = "SELECT * FROM `patient_register` WHERE username='$search_username'";
...
if (isset($_POST['update'])) {
    ...
    if ($pass1 != "" && $pass2 != "") {
        if ($pass1 == $pass2) {
            $query = "UPDATE `patient_register` SET `password` = '$pass1' WHERE username = '$search_username'";
            $result = mysqli_query($conn, $query);
...
if (isset($_POST['delete'])) {
  $search_username = $_POST['search_username'];
  $query = "DELETE FROM `patient_register` WHERE username = '$search_username'";
  $result = mysqli_query($conn, $query);
  ...
  <div class="container-fluid">
    <div class="header d-flex align-items-center justify-content-center">
      <div class="text-center">
        ...
        <p>This is the page where you can search, update, or delete user details.</p>
      </div>
    </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="text" id="fullname" name="fullname" class="form-control" value="<?php echo $rows['firstname'];?>" disabled>
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="form-group">
