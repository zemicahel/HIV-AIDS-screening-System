...
error_reporting(0);
$query = "SELECT * FROM `proffesionals` WHERE username='$id'";
...
if (isset($_POST['update'])) {
    if ($pass1 != "" && $pass2 != "") {
        if ($pass1 == $pass2) {
            $query = "UPDATE `proffesionals` SET `password` = '$pass1' WHERE username = '$id1'";
            $result = mysqli_query($conn, $query);
...
<nav class="navbar-main">
    ...
    <li class="dropdown">
      <a href="#">
        <div class="media align-items-right">
          ...
          <i class="bi bi-person-circle"></i> <span class="mb-0 text-sm font-weight-bold"><?php echo $rows['username'] ?></span>
          </div>
          <!-- Profile icon -->
  ...
  <div class="header">
    <h1>Hello <?php echo $rows['full_name'] ?></h1>
  ...
  <div class="container-fluid">
    <div class="card">
      <div class="card-body">
        <div class="text-left">
          <h1><label for="name">Proffesion: </label> <?php echo $rows['proffesion']; ?></h1>
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="text" id="fullname" name="fullname" class="form-control" placeholder="<?php echo $rows['full_name']; ?>" disabled="disabled">
                </div>
              </div>
              <div class="col-lg-6">
                <div class="form-group">
