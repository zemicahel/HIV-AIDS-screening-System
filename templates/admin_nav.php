...
<body>
    ...
    <div class="container">
     ...
     <div class="lists">
                ...
                <li>
                    <a href="all_proffesionals.php">
                        <img src="images/experts.png" width="30px" height="30px" alt="Your Data Icon">
                    All Profesionals
                    </a>
                </li>
                <li>
                    <a href="all_users.php">
                        <img src="images/yourdata.gif" width="30px" height="30px" alt="Your Data Icon">
                        patient result
                    </a>
                </li>
                <li>    
            ...
            <li>
                <a href="add_professional.php"   ><img src="images/add_user.png" width="30px" height="30px" alt="Your expert Icon">Add Professional</a>
            </li>
            <li>
                <a href="user_controll.php"><img src="images/controll.png" width="30px" height="30px" alt="Your controll Icon">User Controll</a>
            </li>
            <li>
                <a href="proffessional_controll.php"><img src="images/controll.png" width="30px" height="30px" alt="Your controll Icon">Professional Controll</a>
            </li>
            <li>
                <a href="admin_setting.php"><img src="images/setting.gif" width="30px" height="30px" alt="Your Setting Icon">Settings</a>
            </li>
            <li>
