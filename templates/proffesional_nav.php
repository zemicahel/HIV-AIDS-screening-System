...
<body>
    ...
    <div class="container">
        <nav class="sidebar">
            <div class="logo">
                <img src="images/hivimage.png" alt="Logo" height="60px" width="60px"> <h2>HADES</h2>
            </div>
       <div class="lists" >
            <ul>
            <li class="active">
                <a href="proffesional_dashboard.php">
         ...
         <ul>
            ...
            <li>
            <li>
                <a href="proffesional_setting.php"><img src="images/setting.gif" width="30px" height="30px" alt="Your Setting Icon">Settings</a>
            </li>
            <li>
